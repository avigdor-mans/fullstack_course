...
export const anecdote = (content) => ({ type: 'addAnecdote', data: content })
...
export const setNotification = message => ({ type:'disply', message:message})
export const removeNotification = message => ({ type:'remove', message:message})
